...
public class EmailTestController extends JFrame {
    ...
    private void setupUI() {
        ...
        JLabel instruction = new JLabel("<html><b>📋 Test Instructions:</b><br>" +
                "1. Enter your real email address<br>" +
                "2. A random 6-digit code is generated automatically<br>" +
                "3. Click 'Send Test Email' button<br>" +
                "4. Check your email inbox (and spam folder)<br>" +
                "5. Verify if the email with code arrived</html>");
        ...
        if (responseCode == 200) {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                if ("true".equals(responseBody.trim())) {
                    showSuccess("✅ Email sent successfully! Check your inbox (and spam folder).");
